!function (d) {
        ...
        if ("undefined" != n) {
          ...
          p = n.innerWidth(), setTimeout(function () {
            d(".main-menu .item-megamenu").each(function (n, e) {
              ...
              var a = d(e).children(".megamenu").outerWidth(), t = d(e).outerWidth(), l = s.left, u = l + p,
                i = d(e).offset().left, r = i - l < a / 2, f = u < a / 2 + i;
  ...
  d(document).ready(function () {
    n(), e(), d(document).on("click", ".menu-toggle", function () {
      ...
      var e = d(this), a = e.closest(".menu-item"), t = e.closest(".akasha-menu-panel"), l = e.attr("href");
      if (d(l).length) {
        ...
        var u = a.find(".akasha-menu-item-title").attr("title"), i = "";
      ...
      if (void 0 === l || 0 == typeof l) d(".akasha-menu-panels-actions-wrap .akasha-menu-prev-panel").remove(), d(".akasha-menu-panels-actions-wrap .akasha-menu-current-panel-title").remove(); else {
...
jQuery(function (e) {
  ...
  e("body").on("init", ".akasha-tabs-wrapper, .akasha-tabs", function () {
    ...
    var a = window.location.hash, t = window.location.href, n = e(this).find(".akasha-tabs, ul.tabs").first();
    ...
    a.preventDefault();
    var t = e(this), n = t.closest(".akasha-tabs-wrapper, .akasha-tabs");
    ...
    }), e(".akasha-product-gallery .akasha-product-gallery__image").zoom()
    ...
    var t = $(a.target).closest(".akasha-dropdown"), n = $(".akasha-dropdown");
    0 < t.length ? (n.not(t).removeClass("open"), ($(a.target).is('[data-akasha="akasha-dropdown"]') || 0 < $(a.target).closest('[data-akasha="akasha-dropdown"]').length) && (t.toggleClass("open"), a.preventDefault())) : $(".akasha-dropdown").removeClass("open")
    ...
    var t = $(this), n = t.data("id"), e = t.attr("href"), s = t.data("ajax"), l = t.data("section"),
      i = t.data("animate"), o = t.closest(".tab-link,.akasha-accordion").find("a.loaded").attr("href");
    1 != s || t.hasClass("loaded") ? (t.parent().addClass("active").siblings().removeClass("active"), $(e).addClass("active").siblings().removeClass("active"), t.closest(".panel-default").addClass("active").siblings().removeClass("active"), t.closest(".akasha-accordion").find(e).slideDown(400), t.closest(".akasha-accordion").find(".panel-collapse").not(e).slideUp(400), akasha_animation_tabs($(e), i)) : ($(e).closest(".tab-container,.akasha-accordion").addClass("loading"), t.parent().addClass("active").siblings().removeClass("active"), $.ajax({
      ...
      data: { action: "akasha_ajax_tabs", security: akasha_ajax_frontend.security, id: n, section_id: l },
      success: function (a) {
...
jQuery(function (u) {
  ...
  window.addEventListener("load", function (t) {
    ...
    s = u(".akasha-mapper"), e = u(".akasha-pin"), a = s.data("width"), i = s.data("height"), e.each(function () {
      ...
      t.on("click", function () {
        var t = u(this), s = t.siblings(".akasha-popup");
        if (s.length) {
        ...
        var t = u(this).closest(".akasha-pin"), s = t.find(".akasha-popup");
